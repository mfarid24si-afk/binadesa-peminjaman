...
<div class="text-center mb-4">
  <img src="{{ asset('assets/images/logo.png') }}" alt="Logo" style="height:60px; margin-bottom:10px;">
      ...
      @if($errors->any())
        <div class="mdc-card" style="background-color: #ffebee; color: #c62828; padding: 12px; margin-bottom: 16px; border-radius: 8px;">
          {{ $errors->first() }}
        </div>
      @endif
          ...
          <div class="mdc-layout-grid__inner">
            ...
            <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12">
              <div class="mdc-text-field w-100">
                <input class="mdc-text-field__input" type="email" name="email" id="email-input" value="{{ old('email') }}">
...
<a href="https://wa.me/6281234567890" class="whatsapp-float" target="_blank">
  <img src="{{ asset('assets/images/whatsapp-icon.jpg') }}" alt="WhatsApp" class="whatsapp-icon">
</a>
